...
- The record page's action menu offers user-specific actions instead of the usual ones: **Send password reset email**, and, for super admins only, **Login as** (impersonation, covered in the [Impersonation guide](impersonation-guide.md)).
