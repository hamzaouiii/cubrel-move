...
const emitExportClicked = () => emit("exportClicked");
  ...
  <div class="delete-zone">
    <div class="delete-zone__text">
      ...
      <div v-if="!totalSelected">
        <span>{{ $t("modules.export.description") }}</span>
      </div>

      <!-- Selected count -->
      <div v-else>
        <span>
          {{ $t("modules.export.selected_count", { count: totalSelected }) }}
        </span>
      </div>
      ...
      >
        {{ $t("modules.export.select_all", { total: meta.total }) }}
      </span>
      <span v-else> </span>
    </div>
    ...
    <div class="list__actions">
      ...
      >
        {{ $t("modules.export.clear_selection") }}
      </button>
