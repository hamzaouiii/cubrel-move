...
// Group modules by category, excluding 'settings' and the pinned current module
const groupedModules = computed(() => {
    const groups = {};
    modules.value.forEach((mod) => {
        if (currentModule.value && mod.slug === currentModule.value.slug)
            return;
...
<template>
    ...
    >
        ...
        <div class="sidebar__module-list">
            ...
            <template
                v-for="(mods, category) in groupedModules"
                :key="category"
            >
                <hr class="sidebar__module-list__divider" />
