...
return [
    ...
    'modules' => [
        ...
        'module_category_id' => 'Kategorie',
        'module_category_id_hint' => 'Die Gruppe, unter der dieses Modul in der Sidebar-Navigation angezeigt wird. Weitere Kategorien können unter Einstellungen -> Modul-Kategorien erstellt werden.',
        'name' => 'Name',
    ...
    'sidebar' => [
        'sort_by_category' => 'Nach Kategorie ordnen und sortieren',
        'sort_by_category_hint' => 'Gruppiere Sidebar-Module in Kategorie-Abschnitte, die du neu anordnen kannst. Schalte es aus, um alle Module frei in einer einzigen Liste zu sortieren. Kategorien selbst werden auf der Seite Modul-Kategorien umbenannt.',
        'no_modules' => 'Keine Module in dieser Kategorie',
        'save' => 'Reihenfolge speichern',
        'saving' => 'Wird gespeichert...',
        'reset' => 'Zurücksetzen',
        'save_success' => 'Sidebar-Reihenfolge erfolgreich gespeichert',
    ],
    'module_categories' => [
        'title' => 'Modul-Kategorien',
        'description' => 'Die Kategorien, unter denen Module in der Sidebar gruppiert werden. Benenne sie um, ordne sie neu an oder füge neue hinzu.',
        'label' => 'Kategorie',
        'label_placeholder' => 'Kategoriename',
        ...
        'update_success' => 'Kategorie erfolgreich umbenannt',
        'delete_success' => 'Kategorie gelöscht',
        'in_use_error' => 'Dieser Kategorie sind noch Module zugeordnet. Verschiebe sie zuerst in eine andere Kategorie.',
    ],
    'items' => [
        'sidebar' => 'Sidebar',
        'module_categories' => 'Modul-Kategorien',
