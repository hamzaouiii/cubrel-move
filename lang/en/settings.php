...
return [
    ...
    'modules' => [
        ...
        'display_label_hint' => 'The name shown throughout Cubrel for this Module, in the sidebar, page titles, and list views.',
        'name' => 'Name',
        'name_placeholder' => 'Module Name',
        'slug' => 'System Name',
        'slug_hint' => 'A unique, URL-safe identifier generated automatically from the display label. Used internally',
        'icon' => 'Icon',
        'icon_hint' => 'The icon shown next to this module in the sidebar and throughout Cubrel.',
        'color' => 'Color',
        'color_hint' => "The accent color used for this module's icon, buttons, and highlights. Will be overrriden if 'Use Single Module Colors' is disabled in styles settings",
        'show_in_sidebar' => 'Show In Sidebar',
        'description' => 'Description',
        'single_label' => 'Single Label',
        'single_label_hint' => 'The singular form of the module name, used when referring to one record (e.g. \'Product\' instead of \'Products\').',
        'module_category_id' => 'Category',
        'module_category_id_hint' => 'The group this module appears under in the sidebar navigation. More categories can be created under Settings -> Module Categories.',
    ...
    'fields' => [
        ...
        'notify_email_record_converted' => 'Email me when a record I own is converted',
        'notify_email_transformation_triggered' => 'Email me when my change triggers an automatic conversion',
        'notify_email_transformation_automation_failed' => 'Email me when an automatic conversion rule fails to run',
        ...
        'notify_inapp_record_converted' => 'Show an in-app notification when a record I own is converted',
        'notify_inapp_transformation_triggered' => 'Show an in-app notification when my change triggers an automatic conversion',
        'notify_inapp_transformation_automation_failed' => 'Show an in-app notification when an automatic conversion rule fails to run',
    ...
    'sidebar' => [
        'sort_by_category' => 'Order and sort by category',
        'sort_by_category_hint' => 'Group sidebar modules into category sections you can reorder. Turn off to freely reorder all modules in a single list. Categories themselves are renamed on the Module Categories page.',
        'no_modules' => 'No modules in this category',
        'save' => 'Save Order',
        'saving' => 'Saving...',
        'reset' => 'Reset',
        'save_success' => 'Sidebar order saved successfully',
    ],
    'module_categories' => [
        'title' => 'Module Categories',
        'description' => 'The categories modules are grouped under in the sidebar. Rename, reorder, or add new ones.',
        'label' => 'Category',
        'label_placeholder' => 'Category name',
        'add' => 'Add Category',
        'modules_count' => 'Modules',
        'no_categories' => 'No categories yet',
        'confirm_delete' => 'Delete',
        'create_success' => 'Category created successfully',
        'update_success' => 'Category renamed successfully',
        'delete_success' => 'Category deleted',
        'in_use_error' => 'This category still has modules assigned to it. Move them to another category first.',
    ],
    'items' => [
      "sidebar" => "Sidebar",
