...
return [
    ...
    'modules' => [
        ...
        'category' => 'Category',
        'category_hint' => 'The group this module appears under in the sidebar navigation. More categories can be created via dropdown editor in settings by editing the list \'module_category_list\'',
