...
return array(
  ...
  array(
    ...
    4 =>
    array(
      'label' => 'dropdowns.orders_status_list.complete',
      'value' => 'complete',
      'status' => 'success',
    ),
    5 =>
  ...
  'users_type_list' => array(
    array('label' => 'dropdowns.users_type_list.admin', 'value' => 'admin', 'status' => 'danger'),
    array('label' => 'dropdowns.users_type_list.executive', 'value' => 'executive', 'status' => 'danger'),
    array('label' => 'dropdowns.users_type_list.sales_rep', 'value' => 'sales_rep', 'status' => 'success'),
    array('label' => 'dropdowns.users_type_list.sales_manager', 'value' => 'sales_manager', 'status' => 'success'),
    array('label' => 'dropdowns.users_type_list.support_agent', 'value' => 'support_agent', 'status' => 'info'),
    array('label' => 'dropdowns.users_type_list.marketing_user', 'value' => 'marketing_user', 'status' => 'info'),
    array('label' => 'dropdowns.users_type_list.read_only', 'value' => 'read_only', 'status' => 'default'),
  ),
